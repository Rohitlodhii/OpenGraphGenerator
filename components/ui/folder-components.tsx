...
type FolderColor = "blue" | "black" | "grey" | "yellow" | "orange" | "red" | "theme";
...
> = {
  ...
  theme: {
    folder: "from-accent to-accent/70",
    flap: "bg-background/60",
    paperBack: "bg-muted/70",
    paperFront: "bg-card",
    paperLine: "bg-muted-foreground/30",
    paperBorder: "border-border",
    labelBg: "bg-foreground/10",
    folderBorder: "border-border",
  },
};
